...
<div class="container">
    <header class="d-flex justify-content-center py-3">
        ...
        <ul class="nav nav-pills">
            ...
            <li class="nav-tabs"><a href="affichage_texte.php" class="nav-link active nav-color">Fichier</a></li>
...
<div class="container-fluid">    
    ...
    <!-- Affichage de la transcription/normalisation et légence -->
    <div class="row mt-3">
        ...
        <div class="carousel-inner">
            ...
            for ($i = 1; $i <= $nombre_scans; $i++) {
                ...
                <div class="carousel-item <?php echo $i === 1 ? 'active' : ''; ?>">
                    ...
                    <img class="d-block mx-auto w-80 img-responsive" src="<?php echo $image_path; ?>" alt="Scan <?php echo $i; ?>" data-toggle="modal" data-target="#imageModal">
                </div>
                <?php
            }
            ?>
...
<div class="modal fade" id="imageModal" tabindex="-1" aria-labelledby="imageModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg"> <!-- Utilisation de la classe modal-lg pour une modal de largeur large -->
    <div class="modal-content">
      ...
      <div class="modal-body">
        <img class="img-fluid" src="<?php echo $image_path; ?>" alt="Scan <?php echo $i; ?>">
      </div>
    </div>
  </div>
</div>
...
btnNormalisation.addEventListener('click', function() {
    ...
    // Ajout de la classe transcription que met le texte en noir
