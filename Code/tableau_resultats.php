...
<div class="container">
  <header class="d-flex justify-content-center py-3">
    ...
    <ul class="nav nav-pills">
      ...
      <li class="nav-tabs"><a href="index.php" class="nav-link">Connexion</a></li>
      <?php } ?>
      <li class="nav-tabs"><a href="recherche.php" class="nav-link">Recherche</a></li>
      <li class="nav-tabs"><a href="tableau_resultats.php" class="nav-link active nav-color">Résultats</a></li>
      <li class="nav-tabs"><a href="tableau_resultats.php?tableau_de_bord=true" class="nav-link">Tableau de bord</a></li>
