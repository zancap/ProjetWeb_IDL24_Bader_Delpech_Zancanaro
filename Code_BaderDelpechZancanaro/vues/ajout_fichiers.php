...
<div class="container">
    <header class="d-flex justify-content-center py-3">
        ...
        <ul class="nav nav-pills">
            ...
            <li class="nav-tabs"><a href="../vues/ajout_fichiers.php" class="nav-link active nav-color">Ajout</a></li>
...
<script>
    // Affichage de la boîte modale d'accueil
    ...
    $(document).ready(function() {
        ...
        // Détecter les changements dans le champ de fichier
