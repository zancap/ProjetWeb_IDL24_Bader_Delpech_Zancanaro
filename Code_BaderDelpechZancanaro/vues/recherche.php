  ...
  <header class="d-flex justify-content-center py-3">
    <div>
      ...
      <ul class="nav nav-pills">
        ...
        <li class="nav-tabs"><a href="../vues/recherche.php" class="nav-link active nav-color">Recherche</a></li>
...
<form class="container mt-5 mb-4" action="../vues/tableau_resultats.php" method="POST" target="_blank">
  <div class="row">
...
<script>
// Sélection multiple d'options (niveau)
...
<script>
// Sélection multiple d'options (année)
...
<!-- Normalisation, commentaires, longueur et taux d'erreur -->
  <div class="row mt-3 mb-4 color-row3">
    <div class="col-md-3">
      ...
      <div class="form-check form-check-inline">
        <input class="form-check-input" type="radio" id="norm" name="normalisation" value="OUI">
        <label class="form-check-label" for="norm">Oui</label>
      </div>
      <div class="form-check form-check-inline">
        <input class="form-check-input" type="radio" id="no-norm" name="normalisation" value="NON">
        <label class="form-check-label" for="no-norm">Non</label>
      </div>
      <div class="form-check form-check-inline">
        <input class="form-check-input" type="radio" id="no-norm" name="normalisation" value="AUTRE">
        <label class="form-check-label" for="no-norm">Peu importe</label>
      </div>
    </div>
